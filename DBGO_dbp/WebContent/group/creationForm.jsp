		...
		<div class="centerElement">
			<div class="signIn">
				...
				<div class="centerInput">
					<div class="groupName">
						<h5>그룹명</h5>
						<input type="text" class="form-control" name="name" placeholder="" style="width: 230px; height: 50px;"
							<c:if test="${creationFailed}">value="${group.g_name}"</c:if>>	         
					</div>
					<div class="groupMem">
						<h5>구성원</h5>
						<input type="text" class="form-control" name="mem" placeholder="" style="width: 160px; height: 50px;">
