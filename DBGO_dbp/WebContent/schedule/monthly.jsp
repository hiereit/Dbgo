...
.fc .fc-list-event-dot {
	...
	border: calc(var(- -fc-list-event-dot-width, 10px)/2) solid
		var(- -fc-event-border-color, #f3969a);
	border-radius: 5px;
			...
			<form name="form" method="POST"
				...
				<fieldset>
					<button type="button" id="subBtn"
						class="btn btn-warning btn-rounded" onClick="add()">등록</button>
					<a href="<c:url value='/schedule/monthly' />"><button
							type="button" class="btn btn-warning btn-rounded">취소</button></a>
					<div class="form-group row">
						<label id="cateIcon" for="selectCategory"
							class="col-md-1 col-form-label"><i class="fa fa-folder"
							aria-hidden="true"></i></label> <select name="category"
							class="selectCategory" onchange="getval(this);">
					...
					<div class="form-group">
						<input type="text" class="form-control-plaintext"
							id="inputScheduleTitle" placeholder="일정 제목" name="title">
					</div>
					<hr>
					<div class="inputContent">
						<div class="form-group row">
							<label class="col-md-1 col-form-label "><svg width="1em"
									height="1em" viewBox="0 0 16 16" class="bi bi-calendar-range"
									fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  							<path fill-rule="evenodd"
										d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z" />
  							<path
										d="M9 7a1 1 0 0 1 1-1h5v2h-5a1 1 0 0 1-1-1zM1 9h4a1 1 0 0 1 0 2H1V9z" /></svg></label>
							<div class="col-md-11">
								<input type="text" class="form-control-plaintext"
									id="newStartDate" placeholder="시작 날짜" name="startDate" readonly>
								<input type="text" class="form-control-plaintext"
									id="newEndDate" placeholder="마지막 날짜" name="endDate" readonly>
							</div>
						</div>
						<div class="form-group row">
			...
			<form name="update" method="POST"
				...
				<fieldset>
					<button type="button" id="deleteBtn"
						class="btn btn-warning btn-rounded" value="delete" onClick="del()">삭제</button>
					<button type="button" id="updateBtn"
						class="btn btn-warning btn-rounded" value="update" onClick="upd()">수정</button>
					<a href="<c:url value='/schedule/monthly' />"><button
							type="button" class="btn btn-warning btn-rounded">취소</button></a>
					<div class="form-group row">
					...
					<div class="inputContent">
						<div class="form-group row">
							...
							<div class="col-md-11">
								<input type="text" class="form-control-plaintext"
									id="updateStartDate" placeholder="시작 날짜" name="startDate"
									readonly> <input type="text"
									class="form-control-plaintext" id="updateEndDate"
									placeholder="마지막 날짜" name="endDate" readonly>
							</div>
						</div>
						<div class="form-group row">
							<label for="inputMemo" class="col-md-1 col-form-label"><i
