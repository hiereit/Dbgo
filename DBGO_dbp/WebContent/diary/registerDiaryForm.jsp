		...
		<div class="diary">
			<div id="form-div">
				<form name="form" method="POST"
					action="<c:url value='/diary/insert'/>">
					<fieldset>
						<button type="submit" id="subBtn"
							class="btn btn-warning btn-rounded">등록</button>
						<div class="form-group">
							...
							<textarea name="content" class="form-control"
								id="exampleTextarea" rows="3" maxlength="1500"
								onKeyUp="javascript:fnChkByte(this,'1500')"
								style="font-family: JSDongkang-Regular; margin-top: 0px; margin-bottom: 0px; height: 336px;"></textarea>
							<br />
							<div id="byte">
								<span id="byteInfo">0</span>/1500
							</div>
						</div>
					</fieldset>
				</form>
