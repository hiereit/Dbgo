		...
		<div class="collapse navbar-collapse" id="navbarColor01">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item"><a class="nav-link"
					href="<c:url value='/schedule/monthly'/>">개인일정</a></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle"
					href="<c:url value='/group/list'/>" id="navbardrop"
					data-toggle="dropdown">그룹일정</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<c:url value='/group/list'/>">일정
							확인</a> <a class="dropdown-item"
							href="<c:url value='/group/create/form'/>">그룹 생성</a> <a
							class="dropdown-item" href="<c:url value='/group/update'/>">그룹원
							추가</a>
					</div></li>
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<c:url value='/diary/list'/>">일기
							보기</a> <a class="dropdown-item"
			...
			<c:choose>
				<c:when test="${isLogined==true}">
					<a href="<c:url value='/user/logout' />">
						<button class="btn">
							<i class="fa fa-sign-out" style="font-size: 36px; color: white;"></i>
						</button>
					</a>
				</c:when>
				<c:otherwise>
